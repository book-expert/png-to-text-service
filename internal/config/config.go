...
func Load(promptConfigPath string, _ *logger.Logger) (*Config, error) {
	...
	configuration.LLM.Temperature = getEnvironmentVariableAsFloat("PNG_TO_TEXT_TEMPERATURE", 0.30)
	configuration.LLM.MaxTokens = getEnvironmentVariableAsInteger("PNG_TO_TEXT_MAX_OUTPUT_TOKENS", 65536)
